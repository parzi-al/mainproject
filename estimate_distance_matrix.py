...
def estimate_distance_matrix(
    ...
    estimate_distance_params=None, 
    spring_model_params=None, 
    reference_device=0  # NEW: Specify reference device for distances
):
    '''
    ...
    if use_model == "rss_only":
            ...
            # NEW: Extract distances for the reference device
            if reference_device is not None:
                distances = distance_matrix[reference_device, :]
