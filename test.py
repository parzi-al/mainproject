...
NODES = [
    "Staircase 1", "Elevator 1", "Passage 1", "Electrical & Electronics Department",
    "Turing Lab", "Grace Hopper Lab", "Language Lab", "CAD Lab (CE)",
    "Staircase 2", "Elevator 2", "Gent's Toilet", "Dijkstra Lab",
    "Codd Base Lab", "Boy's Common Room", "Steve Jobs Hall", "Measurements Lab",
    "Michael Faraday Hall", "Departmental Library", "Ladies Toilet", "Fire Exit",
    "Electrical Room"
]
...
def main():
    ...
    fire_thread = threading.Thread(target=simulate_fire_alerts,daemon=True)
    fire_thread.start()
